	...
	<section id="about" class="container-fluid bg-light p-4">
		<div class="row text-center p-4">
			<div class="col-12 col-md-4 col-lg-3 mt-2">
				...
				<a id="download" class="btn btn-block text-light mt-5" href="assets/docs/risselintod_resume.pdf" type="download" download><i class="fas fa-download"></i>&nbsp Download Resume </a>
			</div> <!-- left side -->
		...
		<dir>
			...
			<div class="row like bg-secondary mt-4 p-4">
				...
				<div class="col-12 col-md-3 col-lg-3 offset-sm-3 mt-3 text-center">
					...
					<a class="text-light" target="_blank" href="assets/docs/risselintod_resume.pdf"><button class="btn btn-block view text-light"> View Resume </button></a>
				</div>
			</div>
		</dir>
